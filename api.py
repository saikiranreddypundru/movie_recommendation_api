...
def home():
    ...
    df1=pd.read_csv("C:/Users/Nikolay/Downloads/tmdb_5000_credits.csv/tmdb_5000_credits.csv")
    df2=pd.read_csv("C:/Users/Nikolay/Downloads/tmdb_5000_movies.csv/tmdb_5000_movies.csv")
